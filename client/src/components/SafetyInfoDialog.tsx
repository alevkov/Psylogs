...
export function SafetyInfoDialog({ safetyInfo, substance, open, onOpenChange }: SafetyInfoDialogProps) {
  ...
  // Create the dialog content that will be used in both controlled and uncontrolled versions
  const dialogContent = (
  ...
  // If open and onOpenChange props are provided, use them for controlled dialog
  ...
  // Default uncontrolled dialog with trigger button
  return (
    <Dialog>
