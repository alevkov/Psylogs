...
export function SubstanceTimeline({
  ...
  useEffect(() => {
    try {
      ...
      const padding = 30; // Balanced padding
      const usableWidth = width - 2 * padding;
      const usableHeight = height - (padding + 30); // More room at bottom for labels
      const timeAxisY = height - 30; // Fixed position for time axis
