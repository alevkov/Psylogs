...
export default function SubstanceDetailPage() {
  ...
  }, [activeSection, drawDurationCurve, timePoints]);
  ...
  return (
    <div className="max-w-4xl mx-auto pb-10 px-4 sm:px-6">
          ...
          <div className="rounded-xl overflow-hidden bg-white dark:bg-gray-800 shadow-md">
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                {substance.drug_info.search_url && (
                  <div className="mt-6">
                    <a
                      href={substance.drug_info.search_url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center w-full py-3 px-4 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors"
                    >
      ...
      <div className="fixed bottom-6 right-6">
        <Button
          className="w-12 h-12 rounded-full bg-blue-500 hover:bg-blue-600 shadow-lg flex items-center justify-center"
        >
